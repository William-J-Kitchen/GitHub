...
function Input_Digit(digit) {
    ...
    // we are checking to see if Wait_Second_Operand is true and setting
    ...
    if (Wait_Second_Operand === true) {
        ...
        // otherwise the value is added onto it
...
//this function updates the scren with the contents of Display_Value
